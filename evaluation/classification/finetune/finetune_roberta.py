...
if __name__ == "__main__": 
    parser = argparse.ArgumentParser(description="Fine Tuning RoBERTa Models")
    # Data Arguments
    parser.add_argument("--save_path", type=str, default=os.path.join('script_outputs', 'finetuned_encoder_models', 'roberta-large'))
